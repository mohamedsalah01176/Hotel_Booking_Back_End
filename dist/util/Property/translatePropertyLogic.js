...
const translateToEnLogic = (body, adminBody) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const isSafePlace = dangerousPlace_1.safeProvincesAr.some(item => { var _a; return item === ((_a = body.location.city) === null || _a === void 0 ? void 0 : _a.toLowerCase()); });
    ...
    if (foundProperty && foundProperty.isConfirmed === true) {
        newProperty = new property_1.default(Object.assign(Object.assign({}, translatedBody), { admin: adminBody, isDangerousPlace: !isSafePlace, isConfirmed: true }));
    }
    else {
        newProperty = new property_1.default(Object.assign(Object.assign({}, translatedBody), { admin: adminBody, isActive: false, isDangerousPlace: !isSafePlace, isConfirmed: false }));
    }
...
const translateToArLogic = (body, adminBody) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const isSafePlace = dangerousPlace_1.safeProvincesEn.some(item => { var _a; return item.toLowerCase() === ((_a = body.location.city) === null || _a === void 0 ? void 0 : _a.toLowerCase()); });
